                      ...
                      <div className="dtable-cell hw100">
                        <div className="container text-center">
                          ...
                          <SearchBar
                            cities={this.state.cities}
                            tags={this.state.tags}
                            onCitiesChange={(cities) => {this.handleCitiesChange(cities)}}
                            onTagsChange={(tags) => {this.handleTagsChange(tags)}}
                            onSearchClick={() => {
                          ...
                          <div className="resume-up">
                            ...
                            </a> Vytvořte si profil a sežeňte společnost na vámi zvolenou akci.
                          </div>
                        </div>
                      </div>
                    </div>
